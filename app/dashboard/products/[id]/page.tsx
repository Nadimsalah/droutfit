...
import { Copy, ExternalLink, ArrowLeft, Trash2, Eye, ShoppingBag, CheckCircle2, XCircle, Clock, ImageIcon, RefreshCw, Calendar, Hash, AlertTriangle } from "lucide-react"
...
export default function ProductDetailsPage() {
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            setToast({ isVisible: true, message: "Product archived successfully", type: "success" })
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[600px] gap-4">
                ...
                <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">Accessing Product Data...</p>
            </div>
        )
    }
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8">
                <div className="bg-[#13171F] p-12 rounded-[3rem] border border-white/5 shadow-2xl">
                    ...
                    <h2 className="text-2xl font-black text-white mb-2 uppercase tracking-tighter italic">Product Disconnected</h2>
                    <p className="text-gray-500 mb-8 max-w-[280px] mx-auto text-sm font-medium">The sequence ID provided does not match any current inventory.</p>
                    <Link
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-12 pb-24">
            ...
            <div className="grid lg:grid-cols-12 gap-10">
                {/* Left Column - Image & Quick Access */}
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-[#13171F] border border-white/5 rounded-[2.5rem] p-8 shadow-3xl overflow-hidden relative group">
                        <div className="absolute top-0 right-0 p-4">
                            <div className="px-3 py-1 bg-blue-600 rounded-full text-[9px] font-black text-white shadow-lg">PREMIUM GEN</div>
                        </div>
                        ...
                        <div className="mt-8 flex items-center justify-between">
                            <div>
                                <h3 className="text-gray-500 font-black uppercase tracking-widest text-[10px]">Core Identity</h3>
                    ...
                    <div className="bg-[#13171F] border border-white/5 rounded-[2.5rem] p-8 shadow-3xl">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-[#0B0E14] border border-white/5 rounded-2xl p-5 shadow-inner">
                                <p className="text-gray-500 font-black text-[9px] uppercase tracking-widest">Successful Try-ons</p>
                                <p className="text-3xl font-black text-white mt-2 tracking-tighter italic">{product.usage}</p>
                            </div>
                            <div className="bg-[#0B0E14] border border-white/5 rounded-2xl p-5 shadow-inner">
                                <p className="text-gray-500 font-black text-[9px] uppercase tracking-widest">Uplink Status</p>
                ...
                {/* Right Column - Integration & Activity */}
                <div className="lg:col-span-8 space-y-8">
                    {/* Integration Hub */}
                    <div className="bg-[#13171F] border border-white/5 rounded-[2.5rem] p-8 shadow-3xl">
                        <div className="flex items-center gap-3 mb-2">
                            <ShoppingBag className="h-5 w-5 text-purple-500" />
                            <h3 className="text-white font-black uppercase tracking-widest text-xs italic">Commerce Integration Hub</h3>
                        </div>
                        <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-6 opacity-60">System generated widget uplink — deploy to storefront</p>
                        ...
                        <div className="bg-[#0B0E14] border border-white/5 rounded-3xl p-6 flex flex-col gap-6 shadow-inner relative overflow-hidden group">
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="flex-1 relative">
                                    <input
                                        ...
                                        className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-4 pl-6 pr-4 text-xs font-mono text-blue-400 focus:outline-none cursor-pointer truncate"
                                ...
                                >
                                    Launch Widget <ExternalLink className="h-4 w-4" />
                                </a>
                            </div>
                            ...
                            <div className="flex items-center gap-4 pt-4 border-t border-white/[0.02]">
                                ...
                                <p className="text-[10px] font-black text-gray-600 uppercase tracking-widest">Compatible with Shopify, Woo, and Headless SDKs</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#13171F] border border-white/5 rounded-[2.5rem] shadow-3xl overflow-hidden min-h-[400px] flex flex-col relative group/table">
                        <div className="p-8 border-b border-white/5 flex items-center justify-between bg-[#0B0E14]/30">
                            <div>
                                ...
                                <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest mt-1 opacity-50">Local product try-on history</p>
                            </div>
                            <button
                                onClick={fetchLogs}
                        ...
                        {logsLoading && tryonLogs.length === 0 ? (
                            <div className="flex-1 flex flex-col items-center justify-center py-24 gap-4 animate-in fade-in duration-500">
                                ...
                                <p className="text-gray-500 font-bold uppercase tracking-widest text-[9px] animate-pulse">Decrypting logs...</p>
                            </div>
                        ) : tryonLogs.length === 0 ? (
                            <div className="flex-1 flex flex-col items-center justify-center py-24 text-center px-8">
                                ...
                                <h4 className="text-white font-black uppercase tracking-widest text-[10px] mb-2 tracking-tighter">No Sequence Detected</h4>
                                <p className="text-gray-600 text-xs font-medium max-w-[240px] leading-relaxed mx-auto italic opacity-60">
                                    Results will manifest here once the widget is activated by end-users.
                                </p>
                            </div>
                        ) : (
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm border-separate border-spacing-0">
                                    <thead className="bg-[#0B0E14]/50">
                                        <tr>
                                            <th className="p-6 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] border-b border-white/5">Visual</th>
                                            <th className="p-6 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] border-b border-white/5">Outcome</th>
                                            <th className="p-6 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] border-b border-white/5">Latency</th>
                                            <th className="p-6 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] border-b border-white/5">Timestamp</th>
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-[#0B0E14]/80 backdrop-blur-xl animate-in fade-in duration-300">
                    <div className="relative w-full max-w-md bg-[#13171F] border border-white/5 rounded-[2.5rem] p-8 shadow-[0_0_100px_rgba(0,0,0,0.5)] overflow-hidden scale-in-center">
                        ...
                        <div className="flex flex-col items-center text-center relative z-10">
                            ...
                            <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter mb-2">Final Confirmation</h2>
                            <p className="text-gray-500 text-sm font-medium mb-8">
                                You are about to archive <span className="text-white font-bold">{product.name}</span>. This action is permanent and will decouple all associated telemetry logs.
                            </p>

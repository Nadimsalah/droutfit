...
import { Send, Mail, User, MessageSquare, Globe, BarChart, Loader2, CheckCircle2, Building2, ShieldCheck, Zap, Sparkles, Phone, MapPin } from "lucide-react"
        ...
        try {
            const response = await fetch('/api/contact', {
                ...
                body: JSON.stringify({
                    ...
                    message: `[WEBSITE ${type.toUpperCase()} INQUIRY]\n
${type === "sales" ? `Company: ${formData.company}\nStore URL: ${formData.storeUrl}\nVolume: ${formData.volume}\n` : ""}
        ...
        <div className="min-h-screen bg-[#050608] text-white font-sans">
            ...
            <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    ...
                    >
                        Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 italic">Touch.</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Whether you need technical support or have an enterprise inquiry, our team is standing by to help you scale.
                    </motion.p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 bg-[#0D1117] border border-white/5 rounded-[40px] overflow-hidden shadow-2xl relative">
                    ...
                    <div className="lg:w-1/3 p-8 md:p-12 bg-white/[0.01] border-r border-white/5 space-y-12">
                        <div className="space-y-6">
                            <h3 className="text-xs font-black text-gray-500 uppercase tracking-[0.3em]">Select Department</h3>
                            <div className="flex flex-col gap-3">
                                ...
                                >
                                    ...
                                    <div className="text-left">
                                        <p className="font-bold text-sm uppercase tracking-wider">General Support</p>
                                        <p className="text-[11px] opacity-60">Help with your account</p>
                                    </div>
                                </button>
                                ...
                                >
                                    ...
                                    <div className="text-left">
                                        <p className="font-bold text-sm uppercase tracking-wider">Enterprise Sales</p>
                                        <p className="text-[11px] opacity-60">Custom high-volume pricing</p>
                                    </div>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8 pt-8 border-t border-white/5">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 mt-1 italic">9AM - 6PM EST</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {status === "success" ? (
                            <div className="h-full flex flex-col items-center justify-center text-center space-y-6 py-12">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-3xl font-black text-white uppercase tracking-tight">Request Sent</h3>
                                    <p className="text-gray-400 font-medium">We'll be in touch in less than 24 hours.</p>
                                </div>
                                <button
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <AnimatePresence mode="wait">
                                    {type === "sales" && (
                                        ...
                                        >
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-1">Company</label>
                                                <div className="relative group">
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-1">Store URL</label>
                                                <div className="relative group">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        placeholder={type === "sales" ? "Tell us about your volume needs..." : "How can we help you?"}
                                    />
                                </div>
                                ...
                                >
                                    {status === "sending" ? (
                                        ...
                                        <>
                                            ...
                                            {type === "sales" ? "Submit Sales Inquiry" : "Send Message"}
                                        </>
                                    )}
                                </button>
                            </form>

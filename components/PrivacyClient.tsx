            ...
            <main className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
                ...
                <div className="prose prose-invert prose-blue max-w-none space-y-12">
                    ...
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => (
                        <section key={num} className="border-l-2 border-blue-500/20 pl-6 hover:border-blue-500/50 transition-colors">
                            <h2 className="text-2xl font-bold text-white mb-4">
                                {dict.privacyPage.sections[`s${num}`]}
                            </h2>
                            <p className="leading-relaxed text-gray-400">
                                {dict.privacyPage.sections[`s${num}_content`]}
                            </p>
                        </section>
                    ))}
                </div>

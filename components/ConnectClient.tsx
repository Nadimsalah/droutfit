...
function ConnectContent({ dict, locale }: { dict: any; locale: Locale }) {
...
export default function ConnectClient({ dict, locale }: { dict: any; locale: Locale }) {
    return (
        <div className="min-h-screen bg-[#0a0d14] text-white font-sans selection:bg-blue-500/30 pb-20">
            ...
            <div className="pt-20 px-6">
                <Suspense fallback={
                    ...
                    <ConnectContent dict={dict} locale={locale} />
                </Suspense>
            </div>
        </div>
    );

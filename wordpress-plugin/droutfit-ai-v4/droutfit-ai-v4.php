<?php
/**
 * Plugin Name: DrOutfit AI v4
 * Plugin URI: https://droutfit.com
 * Description: AI Virtual Try-On (Native v4)
 * Version: 4.0.0
 * Author: DrOutfit
 * Text Domain: droutfit-ai-v4
 */

if (!defined('ABSPATH')) exit;

class DrOutfit_AI_v4 {
    ...
    public function settings_init() {
        ...
        if (isset($_POST['droutfit_login']) && check_admin_referer('droutfit_login_action', 'droutfit_login_nonce')) {
            ...
            wp_redirect(admin_url('admin.php?page=droutfit-ai'));
            exit;
        }

<?php
/**
 * Plugin Name: DrOutfit Ultimate v7
 * Plugin URI: https://droutfit.com
 * Description: AI Virtual Try-On (V7 Stable Final)
 * Version: 7.0.0
 * Author: DrOutfit
 * Text Domain: dr-ai-v7-final
 */

if (!defined('ABSPATH')) exit;

class DrOutfit_AI_v7 {
    ...
    public function settings_init() {
        ...
        if (isset($_POST['droutfit_login']) && check_admin_referer('droutfit_login_action', 'droutfit_login_nonce')) {
            ...
            wp_redirect(admin_url('admin.php?page=droutfit-v7'));
            exit;
        }
    ...
    public function inject_tryon_button() {
        ...
        echo '<button type="button" 
                id="droutfit-pro-btn" 
                class="button alt" 
                onclick="if(typeof droutfit_open==\'function\'){droutfit_open(this)}else{console.log(\'Loading...\')}"

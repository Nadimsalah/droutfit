<?php
/**
 * Plugin Name: DrOutfit AI v5
 * Plugin URI: https://droutfit.com
 * Description: AI Virtual Try-On (V5 Stable)
 * Version: 5.0.0
 * Author: DrOutfit
 * Text Domain: dr-ai-v5
 */

if (!defined('ABSPATH')) exit;

class DrOutfit_AI_v5 {
    ...
    public function settings_init() {
        ...
        if (isset($_POST['droutfit_login']) && check_admin_referer('droutfit_login_action', 'droutfit_login_nonce')) {
            ...
            wp_redirect(admin_url('admin.php?page=droutfit-v5'));
            exit;
        }

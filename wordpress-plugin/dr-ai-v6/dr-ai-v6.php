<?php
/**
 * Plugin Name: DrOutfit Dynamic Try-On
 * Plugin URI: https://droutfit.com
 * Description: AI Virtual Try-On (V6 Dynamic Fix)
 * Version: 6.0.0
 * Author: DrOutfit
 * Text Domain: dr-ai-v6
 */

if (!defined('ABSPATH')) exit;

class DrOutfit_AI_v6 {
    ...
    public function settings_init() {
        ...
        if (isset($_POST['droutfit_login']) && check_admin_referer('droutfit_login_action', 'droutfit_login_nonce')) {
            ...
            wp_redirect(admin_url('admin.php?page=droutfit-v6'));
            exit;
        }
